...
def register_shell_context(app):
    ...
    def make_shell_context():
        return dict(db=db, Blogger=Blogger, Article=Article, Comment=Comment)


def register_template_context(app):
    @app.context_processor
    def make_template_context():
        admin = Blogger.query.first()
...
def register_commands(app):
    ...
    @app.cli.command()
    @click.option('--article', default=50, help='Quantity of posts, default is 50.')
